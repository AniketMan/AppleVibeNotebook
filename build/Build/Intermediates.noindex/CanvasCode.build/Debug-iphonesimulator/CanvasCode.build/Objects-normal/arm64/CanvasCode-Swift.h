...
#ifndef CANVASCODE_SWIFT_H
#define CANVASCODE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CanvasCode",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10CanvasCode20ScreenCaptureService")
...
SWIFT_CLASS("_TtC10CanvasCode17VoiceInputService")
